...
// version of site assets, should increase every publish
    pwaSettings.SITE_VERSION = toHash('1651445385000');

// version of runtime files, should increase on every deploy
    pwaSettings.RUNTIME_VERSION = toHash('2023-11-07T13_49_37');
...
importScripts('https://static.cdn-website.com/workbox/workbox-v3.6.3/workbox-sw.js');
workbox.setConfig({
    debug: false,
    modulePathPrefix: 'https://static.cdn-website.com/workbox/workbox-v3.6.3/',
});
